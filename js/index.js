const localization = {
  ru: {
    ...
    erkeHistory2:
      "На Олимпийских играх 2012 года спонсировал олимпийские комитеты Южной Африки, Ирана и Узбекистана, которые в общей сложности завоевали 22 медали. В 2013, продолжение сотрудничества с Олимпийскими комитетами ЮАР и недавно спонсируемым Олимпийским комитетом Туркменистана. В 2016 году ERKE становится официальным партнером Организационного комитета Олимпийских игр Хорватии",
    erkeHistory3:
    ...
    xtepHistory3:
      "С момента своего создания в 2001 году основной бренд группы “Xtep” имеет обширную дистрибьюторскую сеть из более чем 7500 розничных магазинов, охватывающих 31 провинцию, автономный район и муниципалитет Китая, а также зарубежные регионы. В настоящее время зарубежные продажи продукции в Азии, Европе и на Среднем Востоке.\n25.11.2021 года было официальное открытие первого магазина XTEP в Кыргызстане г.Бишкек",
    adidasHistory1:
      "С момента своего основания в 1949 году, штаб-квартира adidas Group расположена в Херцогенаурахе, Германия. Благодаря десятилетиям упорной работы и инноваций, adidas превратилась в один из ведущих мировых спортивных брендов. Компания объединяет в себе обширные возможности исследований и разработок, производства, продаж и маркетинга, что позволяет ей оставаться на передовой спортивной индустрии.",
    adidasHistory2:
  ...
  en: {
    ...
    erkeHistory2:
      "At the 2012 Olympics sponsored the Olympic committees of the South Africa, Iran and Uzbekistan, which in total difficulties won 22 medals. IN 2013,continuation of cooperation with the Olympic South African committees and the recently sponsored Olympic Committee of Turkmenistan. In 2016 ERKE becomes an official partner Organizing Committee of the Olympic Games Croatia",
    erkeHistory3:
    ...
    adidasHistory1:
      "The adidas Group has been headquartered in Herzogenaurach, Germany since its founding in 1949. Through decades of hard work and innovation, adidas has evolved into one of the world's leading sports brands. The company combines extensive research and development, manufacturing, sales and marketing capabilities to stay at the forefront of the sports industry.",
    adidasHistory2:
  ...
  kg: {
    ...
    erkeHistory2:
      "2012-жылкы Олимпиадада Түштүктүн олимпиадалык комитеттери тарабынан каржыланган Африка, Иран жана Өзбекстан, алар бардыгы болуп саналат кыйынчылыктар 22 медалга ээ болду.2013ТӨ,Олимпиада менен кызматташууну улантуу Түштүк африкалык комитеттер жана жакында демөөрчүлүк кылган Түркмөнстандын Олимпиада комитети.2016-жылы ERKE расмий өнөктөш болот Олимпиадалык оюндарды уюштуруу комитети Хорватия",
    erkeHistory3:
    ...
    adidasHistory1:
      "Adidas компаниясы 1949-жылы негизделгенден бери Германиянын Герцогенаурах шаарында жайгашкан. Көп жылдык мээнет жана инновациялар аркылуу adidas дүйнөнүн алдыңкы спорт брендеринин бирине айланды. Компания спорт индустриясында алдыңкы орунда калуу үчүн кеңири изилдөө жана өнүктүрүү, өндүрүш, сатуу жана маркетинг мүмкүнчүлүктөрүн бириктирет.",

    adidasHistory2:
      "Adidas инновацияларга берилген жана эң акыркы технологияларды колдонуу менен жогорку сапаттагы продукцияларды түзөт. Туруктуу өнүгүү жана экологиялык таза материалдарга өзгөчө көңүл бурулат, бул компаниянын ар кандай экологиялык демилгелеринде чагылдырылат.",
...
function changeLanguage(language) {
  ...
  document.getElementById("erkeHistory2").textContent =
    localization[language].erkeHistory2;
  document.getElementById("erkeHistory3").textContent =
    localization[language].erkeHistory3;

  document.getElementById("xtepHistory1").textContent =
    localization[language].xtepHistory1;
  document.getElementById("xtepHistory2").textContent =
    localization[language].xtepHistory2;
  document.getElementById("xtepHistory3").textContent =
    localization[language].xtepHistory3;
...
document
  .getElementById("lang-kg")
  .addEventListener("click", () => changeLanguage("kg"));
